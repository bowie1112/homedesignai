...
const subscriptionFeatures = {
  starter: [
    "Basic 1K and Pro 2K models",
    "All home and floor plan design tools",
    "Private design history",
...
export const paymentPlans = {
  starter_monthly_v2: {
    ...
    amount: 999,
    currency: "usd",
    creditsPerInvoice: 100,
    interval: "month",
    description: "For homeowners exploring rooms, exteriors, and floor plans.",
    features: subscriptionFeatures.starter,
    visible: true,
  },
  professional_monthly_v2: {
    id: "professional_monthly_v2",
    ...
    interval: "month",
    description: "For designers, agents, and renovators comparing more directions.",
    features: subscriptionFeatures.professional,
    badge: "Most Popular",
    visible: true,
  },
  enterprise_monthly_v2: {
    id: "enterprise_monthly_v2",
    ...
    interval: "month",
    description: "For studios and teams with a steady design workflow.",
    features: subscriptionFeatures.enterprise,
    badge: "Best Value",
    visible: true,
  },
  starter_yearly_v2: {
    id: "starter_yearly_v2",
    name: "Home Design AI Starter Yearly",
    tier: "starter",
    billingMode: "yearly",
    kind: "subscription",
    amount: 9590,
    monthlyEquivalentAmount: 799,
    currency: "usd",
    creditsPerInvoice: 1200,
    interval: "year",
    description: "For homeowners exploring rooms, exteriors, and floor plans.",
    features: subscriptionFeatures.starter,
    visible: true,
  },
  professional_yearly_v2: {
    id: "professional_yearly_v2",
    name: "Home Design AI Professional Yearly",
    tier: "professional",
    billingMode: "yearly",
    kind: "subscription",
    amount: 28790,
    monthlyEquivalentAmount: 2399,
    currency: "usd",
    creditsPerInvoice: 3600,
    interval: "year",
    description: "For designers, agents, and renovators comparing more directions.",
    features: subscriptionFeatures.professional,
    badge: "Most Popular",
  ...
  enterprise_yearly_v2: {
    id: "enterprise_yearly_v2",
    name: "Home Design AI Enterprise Yearly",
    tier: "enterprise",
    billingMode: "yearly",
    kind: "subscription",
    amount: 57590,
    monthlyEquivalentAmount: 4799,
    currency: "usd",
  ...
  pack_starter_v2: {
    ...
    amount: 699,
    currency: "usd",
    creditsPerInvoice: 50,
    description: "For a small project without a subscription.",
    features: packFeatures.starter,
    visible: true,
  },
  pack_professional_v2: {
    id: "pack_professional_v2",
    ...
    description: "For a complete home design project without a subscription.",
    features: packFeatures.professional,
    badge: "Most Popular",
    visible: true,
  },
  pack_enterprise_v2: {
    id: "pack_enterprise_v2",
    ...
    amount: 5999,
    currency: "usd",
    creditsPerInvoice: 500,
    description: "For larger project volumes without a subscription.",
    features: packFeatures.enterprise,
    badge: "Best Value",
    visible: true,
  },

  // Previous public plans remain resolvable for renewals and delayed Stripe events.
  starter_monthly: {
    id: "starter_monthly",
    name: "Home Design AI Starter Monthly",
    tier: "starter",
